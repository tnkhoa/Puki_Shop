...
function php_danhmucsp(){
	...
	switch ($detail) {
		...
		break;
		case 'banphim':
		$sql = "SELECT * FROM sanpham sp, danhmucsp dm WHERE sp.madm = dm.madm AND dm.tendm = 'Bàn phím' ORDER BY sp.gia ASC";
		break;
		case 'chuot':
		$sql = "SELECT * FROM sanpham sp, danhmucsp dm WHERE sp.madm = dm.madm AND dm.tendm = 'Chuột' ORDER BY sp.gia ASC";
		break;
		case 'tainghe':
		$sql = "SELECT * FROM sanpham sp, danhmucsp dm WHERE sp.madm = dm.madm AND dm.tendm = 'Tai nghe' ORDER BY sp.gia ASC";
		break;
		case 'loa':
		$sql = "SELECT * FROM sanpham sp, danhmucsp dm WHERE sp.madm = dm.madm AND dm.tendm = 'Loa' ORDER BY sp.gia ASC";
		break;
		case 'usb':
		$sql = "SELECT * FROM sanpham sp, danhmucsp dm WHERE sp.madm = dm.madm AND dm.tendm = 'USB' ORDER BY sp.gia ASC";
		break;
		case 'sacduphong':
		$sql = "SELECT * FROM sanpham sp, danhmucsp dm WHERE sp.madm = dm.madm AND dm.tendm = 'Sạc dự phòng' ORDER BY sp.gia ASC";
		break;
	}
	$sqlx = $sql;
